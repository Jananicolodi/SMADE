...
<?php
    ...
    <div class="container-contact100">
        <div class="wrap-contact100">
            <form class="contact100-form validate-form" action="salvar_aluno.php" method="Post">
                ...
                <div class="wrap-input100 validate-input bg1 rs1-wrap-input100" data-validate="Enter Your Email (e@a.x)">
                    ...
                    $i = 0;
                    echo "<select class=\"js-select2\" name=\"turma\" value=<?=$idTurma?>>";
                    while($registro = mysqli_fetch_array($resultado)){
                        ...
                        <div class="wrap-input100 validate-input bg1" data-validate="Por favor insira o id">
                            ...
                            <input class="input100" type="text" name="idResponsavel" value=<?=$idResponsavel?>>
                        </div>
